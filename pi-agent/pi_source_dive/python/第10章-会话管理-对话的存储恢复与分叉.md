...
![第 1 步：切换模型，第一个节点上树](assets/diagrams/ch10-diagram-5ec901cea0bd.svg)
...
![第 2 步：你提问，UserMessage 节点上树](assets/diagrams/ch10-diagram-6d67d4c4b24c.svg)
...
![第 3 步：Agent 调 read 工具，AssistantMessage 节点上树](assets/diagrams/ch10-diagram-f9279a607c56.svg)
...
![第 4 步：read 工具返回结果，ToolResult 节点上树](assets/diagrams/ch10-diagram-f19b498d087c.svg)
...
![第 5 步：Agent 给出分析，又一个 AssistantMessage](assets/diagrams/ch10-diagram-8534ed755b75.svg)
...
![第 6 步：回退——这是关键转折](assets/diagrams/ch10-diagram-9157ad82109d.svg)
...
![第 7 步：换思路重新问——新分支自然长出](assets/diagrams/ch10-diagram-a6559b3d365e.svg)

### 第 8 步：新分支继续长

Agent 在新分支上调 grep + read 工具，产生 3 个新节点（assistant + toolResult + assistant）：

![第 8 步：新分支继续长](assets/diagrams/ch10-diagram-b70a7eca0ff3.svg)
...
![分支摘要：BranchSummaryEntry——回退时的可选项](assets/diagrams/ch10-diagram-354fd5d3b107.svg)
...
![第二步：按类型分派处理](assets/diagrams/ch10-diagram-c157a8271893.svg)
...
![状态变量：覆盖式提取](assets/diagrams/ch10-diagram-1548dec39949.svg)
...
![CompactionEntry 的特殊处理：选择性收集](assets/diagrams/ch10-diagram-6fb1d2011d49.svg)
