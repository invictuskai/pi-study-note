...
![二、第一层：LLM 认识的消息只有三种](assets/diagrams/ch06-diagram-6c4a38a26c5d.svg)
...
![每种消息的具体数据结构](assets/diagrams/ch06-diagram-960b28862504.svg)
...
![一个完整的对话示例](assets/diagrams/ch06-diagram-7408d228f142.svg)
...
![三、矛盾：Agent 里的消息不止三种](assets/diagrams/ch06-diagram-b91a34024371.svg)
...
![AgentMessage 联合类型](assets/diagrams/ch06-diagram-e9a9c109cd8a.svg)
...
![翻译发生在什么时候？](assets/diagrams/ch06-diagram-49fe5c5db31e.svg)
...
![八、完整数据流：从用户操作到 LLM 看到的消息](assets/diagrams/ch06-diagram-65585b7eddea.svg)
