...
<Diagram file="/assets/diagrams/ch08-diagram-e5e44387b76b.svg" caption="一、问题：窗口是固定的，对话是增长的" id="ch08-diagram-e5e44387b76b" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-2507d3c2445b.svg" caption="二、地图：两层防护" id="ch08-diagram-2507d3c2445b" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-0d27341fb4b8.svg" caption="多级上下文文件：从当前目录向上递归" id="ch08-diagram-0d27341fb4b8" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-72f11f4d662c.svg" caption="多级上下文文件：从当前目录向上递归" id="ch08-diagram-72f11f4d662c" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-d94d9fdfc601.svg" caption="Skills 懒加载：列表进 prompt，内容按需读" id="ch08-diagram-d94d9fdfc601" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-ed94c98f69e1.svg" caption="问题：分支跳转后，旧分支的内容怎么处理？" id="ch08-diagram-ed94c98f69e1" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-fa9c9d6a97da.svg" caption="LCA 算法：找&quot;分叉点&quot;" id="ch08-diagram-fa9c9d6a97da" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch08-diagram-1929c322d433.svg" caption="七、全景链路：一次工具调用经过的所有上下文处理" id="ch08-diagram-1929c322d433" layout="preserve" />
