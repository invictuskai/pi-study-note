...
<Diagram file="/assets/diagrams/pr04-diagram-0fee688fbd5c.svg" caption="二、先认识：pi-agent 的系统提示词注入机制" id="pr04-diagram-0fee688fbd5c" layout="preserve" />
...
<Diagram file="/assets/diagrams/pr04-diagram-bc7799bed0e8.svg" caption="4.1 静态部分：本地文件" id="pr04-diagram-bc7799bed0e8" layout="preserve" />
