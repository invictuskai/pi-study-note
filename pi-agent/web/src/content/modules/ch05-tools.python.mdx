...
<Diagram file="/assets/diagrams/ch05-diagram-b931c0a7a735.svg" caption="并行执行的三阶段设计" id="ch05-diagram-b931c0a7a735" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch05-diagram-9f124f0b47fd.svg" caption="异常 → 消息：编码前后对比" id="ch05-diagram-9f124f0b47fd" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch05-diagram-3a5c3564bca4.svg" caption="关键细节：错误描述越具体，模型纠错能力越强" id="ch05-diagram-3a5c3564bca4" layout="preserve" />
...
<Diagram file="/assets/diagrams/ch05-diagram-6da60485053d.svg" caption="Pi 的真实做法：两层错误处理，分层负责" id="ch05-diagram-6da60485053d" layout="preserve" />
